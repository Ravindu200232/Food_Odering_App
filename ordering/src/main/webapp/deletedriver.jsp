    ...
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-3">
                <form action="deletdri" method="post">
                    ...
                    <div class="col-md-12"><label class="labels">Name</label><input type="text" name="dname" class="form-control" readonly value="<%=name %>"></div>
                    <div class="col-md-12"><label class="labels">email</label><input type="text" name="demail" class="form-control" readonly  value="<%=email %>"></div>
                    <div class="col-md-12"><label class="labels">Phone</label><input type="text" name="dphone" class="form-control" readonly  value="<%=phone %>"></div>
                    <div class="col-md-12"><label class="labels">Address</label><input type="text" name="daddress" class="form-control" readonly  value="<%=address%>"></div>
